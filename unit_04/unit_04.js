...
function f4() {
    ...
    let item = document.querySelector('.i-4');
    div.textContent = item.checked ? 'true' : 'false';
}
...
function f5() {
    ...
    let item = document.querySelector('.i-5');
    let value = document.querySelector('.i-5').getAttribute('value');
    div.textContent = item.checked ? value : 'false';
}
...
function f6() {
    ...
    let value = document.querySelector('.i-6').getAttribute('value');
...
function f7() {
    let div = document.querySelector('.out-71');
...
function f9() {
    let elem = document.querySelector('.r-9');
    if(elem.checked){
        document.querySelector('.out-9').textContent = elem.value;
    }else{
...
function f10() {
    let elem = document.querySelector('.i-10').value;
    document.querySelector('.out-10').style.background = elem;
}
...
function f11() {
    let elem = document.querySelector('.i-111').value;
    let elem2 = document.querySelector('.i-112');
    elem2.value = elem;
}
...
function f12() {
    let elem = document.querySelector('.i-12').value;
    document.querySelector('.out-12').textContent = elem;
}
...
function f13() {    
    let elem = document.querySelector('.i-13').value;
    console.log(elem)
    document.querySelector('.out-13').textContent = elem;
}
...
function f14() {
    let elem = document.querySelector('.t-14').value;
    document.querySelector('.out-14').textContent = elem;
...
function f15() {
    let elem = document.querySelector('.i-15').value;
    document.querySelector('.t-15').textContent = elem;
    document.querySelector('.out-15').textContent = elem; 
}
...
function f16() {
    ...
    let elem = document.querySelector('.s-16').value;
    document.querySelector('.out-16').textContent = elem;
...
function f17() {
    let elem = document.querySelector('.s-17').value;
    document.querySelector('.out-17').textContent = elem;
}
...
function f18() {
    let elem = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = elem;
}
...
function f19() {
    let elem = document.querySelector('.out-19').textContent;
    document.querySelector('.i-19').value = elem;
...
function f20() {
    let elem = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = elem;
}
