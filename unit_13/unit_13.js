...
function f3() {
    ...
    for(item in a3){
        if(a3[item] === 'hi'){
            return document.querySelector('.out-3').innerHTML += ' ' + a3[item];
        }
    }
    // return
}
...
function f6() {
    ...
    let valye = document.querySelector('.i-62').value;
    a6[key] = valye
    console.log(a6)
    f5(a6,'.out-6')
}
...
function f7() {
    let key = document.querySelector('.i-7');
        if(a7[key.value] !== undefined){
...
function f8() {
    let key = document.querySelector('.i-8');
        if(a8[key.value] !== undefined){
            document.querySelector('.out-8').innerHTML = a8[key.value];
        }else{
...
function f9() {
    ...
    for(item in a9){
        if(a9[item] === +key){
            arr.push(document.querySelector('.out-9').innerHTML += item)
        }
    }
    return arr;
}
...
function f15() {
    ...
    arr.join('')
    document.querySelector('.out-15').innerHTML = arr
}
...
function f18() {
    let valye = document.querySelector('.i-18').value;
    for(key in a18){
       if(key === valye){
        document.querySelector('.out-18').innerHTML = ' ' + a18[key]
       }
    }
}
...
function f19() {
    let valye = document.querySelector('.i-19').value;
    for(key in a19){
       a19[key].map(item=>{
           if(item === valye){
               return document.querySelector('.out-19').innerHTML = key
           }
       })
    }
}
