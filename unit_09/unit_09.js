...
function f1() {
    const block = document.querySelector('.out-1');
    block.style.width = '200px';
    block.style.height =  '90px';
    console.log('working')
}

const b1 =  document.querySelector('.b-1').onclick = f1;

//  Task 2
// По нажатию на кнопку .b-2 функция f2, которая присваивает блоку .out-2 класс .bg-orange.

function f2() {
    const block = document.querySelector('.out-2');
...
function f3() {
    const block = document.querySelector('.out-3');
    block.classList.remove('bg-orange');
    console.log('class')
}
...
function f4() {
    const block = document.querySelector('.out-4');
...
function f5() {
    const block = document.querySelector('.out-4');
    const block2 = document.querySelector('.out-5');
    block2.textContent = block.classList.contains('bg-orange');
}
...
function f6() {
    const block = document.querySelector('.out-6');
    const block2 = document.querySelectorAll('.p-6');
    block.textContent = block2.length;
}
...
function f7() {
    for(items of blocks7){
        items.classList.add('bg-orange');
    }
...
function f8() {
    for(items of blocks8){
        items.classList.toggle('bg-orange');
    }
...
let divchik = document.querySelectorAll('.out-10');

for(items of divchik){
    items.onclick = f10;
}
...
function f12() {
    let block = document.querySelector('.out-12');
    let div = document.createElement('div');
    div.textContent = 12;
...
function f13() {
    let block = document.querySelector('.out-13');
    let div = document.createElement('div');
...
function f14() {
    let block = document.querySelector('.out-14');
    let div = document.createElement('div');
    div.textContent = 14;
    div.classList.add('bg-orange');
    block.append(div);
...
function f15() {
    let block = document.querySelector('.out-15');
    let div = document.createElement('div');
    div.textContent = 15;
    div.classList.add('bg-orange');
    block.before(div);
...
function f16() {
    let block = document.querySelector('.out-16');
    let div = document.createElement('div');
    div.textContent = 16;
    div.classList.add('bg-orange');
    block.after(div);
...
function f17() {
    let block = document.querySelector('.out-17');
    let div = document.createElement('div');
    div.textContent = 17;
    div.classList.add('bg-orange');
...
function f18() {
    let block = document.querySelector('.p-18');
    let div = document.querySelector('.out-18');
    div.textContent = block.getAttribute('data-b');
}
...
function f19() {
    let block = document.querySelectorAll('.p-19');
    let div = document.querySelector('.out-19');
    for(items of block){
        let content = items.getAttribute('data-b');
